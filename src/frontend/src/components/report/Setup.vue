<template>
  <div>
    <a href="#" @click="openModal">Report</a>
    <b-modal
      id="report-setup"
      size="lg"
      v-model="modalOpenned"
      title="MRP: Filename Setup"
    >
      <table class="w-100">
        <tr>
      ...
      <template v-slot:modal-footer>
        <div class="w-100 text-center">
          ...
          <b-button variant="secondary" class="mx-3" @click="show=false">Report</b-button>
...
<script>
import SelectBomFile from "@/components/SelectBomFile"
