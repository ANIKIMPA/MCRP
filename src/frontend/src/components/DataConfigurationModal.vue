        ...
        <b-col>
          <b-form-group label="File Type" class="h-92 border p-2">
            <b-form-radio
              ...
              name="file-type"
              value="bomModelParameters"
            >Bill of Material</b-form-radio>
            <b-form-radio
              v-model="fileTypeSelected"
              name="file-type"
              value="mastModelParameters"
            >Master Schedule</b-form-radio>
            <b-form-radio
              v-model="fileTypeSelected"
              name="file-type"
              value="invModelParameters"
            >Inventory Status</b-form-radio>
            <b-form-radio
              v-model="fileTypeSelected"
              name="file-type"
              value="itemMasterModelParameters"
            >Item Master</b-form-radio>
            <b-form-radio
              v-model="fileTypeSelected"
              name="file-type"
              value="resourceCapacityModelParameters"
            >Resource Capacity</b-form-radio>
          </b-form-group>
        </b-col>
        <b-col cols="8">
          <div
            v-if="fileTypeSelected != 'bomModelParameters' && fileTypeSelected != ''"
          ...
          >
            <b-form-group>
              <b-row align-h="between" align-v="center">
                ...
                <b-col cols="4">
                  <SelectBomFile
                    @bomFileSelected="getFileSelected"
                    :createFromBomFile="createFromBomFile"
                  />
                </b-col>
              </b-row>
            </b-form-group>
            ...
            <b-form-group
              label-cols-sm="6"
              :class="{ disabled: !createFromBomFile }"
              label="Copy Items:"
              label-align-sm="left"
              class="mb-0"
            >
