...
class BomFile(models.Model):
    ...
    owner = models.ForeignKey(Usuario, related_name='bom_files', on_delete=models.CASCADE, null=True, blank=True)
...
class MastFile(models.Model):
    ...
    owner = models.ForeignKey(Usuario, related_name='mast_files', on_delete=models.CASCADE, null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)
    created_date = models.DateTimeField(auto_now_add=True)
    removed = models.BooleanField(default=False)
...
class InvFile(models.Model):
    ...
    owner = models.ForeignKey(Usuario, related_name='inv_files', on_delete=models.CASCADE, null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)
    created_date = models.DateTimeField(auto_now_add=True)
    removed = models.BooleanField(default=False)
...
class ItemMasterFile(models.Model):
    title = models.CharField(max_length=50, default="Untitled")
    number_of_items = models.PositiveIntegerField(blank=True, default=1)
    owner = models.ForeignKey(Usuario, related_name='item_master_files', on_delete=models.CASCADE, null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)
    created_date = models.DateTimeField(auto_now_add=True)
    removed = models.BooleanField(default=False)
